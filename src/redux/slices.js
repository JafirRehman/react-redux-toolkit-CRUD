...
//adding user to api
const apidata=createAsyncThunk("apidata",async (users,{rejectWithValue})=>{
  const jsondata=await fetch("https://651ce36c44e393af2d58ddc6.mockapi.io/Crud",{
    method:"POST",
    headers:{
...
const apiallusers=createAsyncThunk("apiallusers",async (xyz,{rejectWithValue})=>{
  const allapiusers=await fetch("https://651ce36c44e393af2d58ddc6.mockapi.io/Crud");
  try{
...
const apideleteuser=createAsyncThunk("apideleteuser",async (id,{rejectWithValue})=>{
  const alldeletinguser=await fetch(`https://651ce36c44e393af2d58ddc6.mockapi.io/Crud/${id}`,{method:"DELETE"});
...
const apiupdateuser=createAsyncThunk("apiupdateuser",async (user,{rejectWithValue})=>{
  const jsonupdateuser=await fetch(`https://651ce36c44e393af2d58ddc6.mockapi.io/Crud/${user.id}`,{
    method:"PUT",
    headers:{
      "Content-Type":"application/json",
    },
